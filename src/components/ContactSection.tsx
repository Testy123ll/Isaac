...
export const ContactSection = () => {
  ...
  if (state.succeeded) {
      return (
        <section id="contact" className="py-24 bg-slate-950 relative overflow-hidden flex flex-col justify-center">
             {/* Background Grid */}
                  ...
                  <div className="flex flex-col gap-4">
                      <a href="mailto:isaactestimony.dev@gmail.com" className="group flex items-center gap-4 p-4 rounded-2xl bg-slate-950 border border-slate-800 hover:border-blue-500/50 transition-all duration-300">
                          ...
                          <div>
                              ...
                              <p className="text-white font-medium">Send email message</p>
                          </div>
                      </a>
